module shu.data.pgsql;

public import shu.data.database;
...
class PgSql : Database
{
	...
	// host=127.0.0.1 port=5432 user=postgres password=roots dbname=test
	...
	string escape(string sqlData)
	{
		...
		uint size = PQescapeString (buffer, sqlData.ptr, sqlData.length);
